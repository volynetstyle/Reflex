...
- як розширювати reflex без розповзання архітектури
...
1. [01-basics.md](./01-basics.md) - базова інтуїція: чим signals відрізняються від звичайних змінних і чому reflex lazy.
...
8. [08-performance.md](./08-performance.md) - cost model reflex, сильні та слабкі workload-сценарії.
